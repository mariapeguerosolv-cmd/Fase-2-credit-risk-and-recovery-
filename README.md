...
4.  **Evidencia de integración (API, _endpoints_, entre otros).**
...
5.  **Imagen construida correctamente.**
...
7.  **Descripción del proceso paso a paso.**
...
2.  **Estrategia de despliegue (contenedores, _PaaS_, entre otros).**
...
3.  **Uso de herramientas de documentación (por ejemplo, Copilot).**
